...
async function main() {
  ...
  console.log('  - Real GPU fill-rate/bandwidth behavior for the Bloom pass and the glass meshPhysicalMaterial (transmission=1, a genuinely expensive material -- refractive glass walls are NOT free, and this script does not attempt to cost that beyond noting it exists).')
