...
| 10 | 2.3 Node MQTT bridge | **in progress** | Blocked-by (6, 8) satisfied; 9 not required to start (gated/mocked tests are the plan's own allowance). Dispatching implementer 2026-07-31. |
...
| 14 | Phase 4 (Moses control, sim visitors, phone controller) | **pending — detailing now** | Undetailed in the plan by design ("expand after Phases 0-3 reviewed"). Phases 0-3 are now done; researching existing Moses agent/frontend architecture 2026-07-31 to write the detailed task breakdown. |
