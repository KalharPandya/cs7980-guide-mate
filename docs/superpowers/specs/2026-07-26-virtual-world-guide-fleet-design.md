...
The actual authored file for the 14th floor is `world/data/floor-14.json` (controller-authored
from the pasted floor plan images, eyeballed coordinates, documented as such in the file's own
`source`/`note` fields).
...
## Detailed task-level plan
See `docs/superpowers/plans/2026-07-26-virtual-world-implementation-plan.md` for the
task-by-task breakdown used for subagent-driven execution, and
`docs/superpowers/plans/2026-07-26-virtual-world-progress.md` for live status.
